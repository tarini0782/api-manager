...
To protect end-user security, vulnerabilities should only be made public **after WSO2 completes its** [Vulnerability Management Process](https://security.docs.wso2.com/en/latest/security-processes/vulnerability-management-process/).
